...
int main()
{
    ...
    for(i = 1; i <= 9; ++i)
        insert(&root, i, queue);
    printf("The tree elements before insertion are(LevelOrder Treaversal): ");
    levelOrder(root);
    printf("\nEnter the value of the node = ");
    scanf("%d",&key);
    root=insertnode(root,key);
    printf("\nThe tree elements after insertion are (Inorder Traversal): ");
    InOrder(root);
    return 0;
}
